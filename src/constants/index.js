...
const projects = [
  {
    name: "crypto-tracker",
    description:
      "Web-based platform that allows users to search,know their price in year month or day and websites where they can buy that.",
    tags: [
      {
        name: "react",
  ...
  },
  {
    ...
    description:"a chrome-extension that when you click on it it showss you a dad joke ",
      tags: [
      {
        name: "Html",
        color: "blue-text-gradient",
  ...
  },
  {
    name: "Virtual-Drum",
    description: 
      "some buttons with alphabets which you can click or press on keyboard will make a sound .",
    tags: [
      {
        name: "javascript",
        color: "blue-text-gradient",
